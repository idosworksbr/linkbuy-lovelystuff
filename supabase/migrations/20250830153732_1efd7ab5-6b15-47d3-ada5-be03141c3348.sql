-- Add a field to control whether custom background is enabled
ALTER TABLE public.profiles 
ADD COLUMN custom_background_enabled boolean DEFAULT false;

-- Update the get_public_store_info function to include the new field
