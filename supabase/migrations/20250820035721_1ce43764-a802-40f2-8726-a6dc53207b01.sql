...
-- Adicionar a coluna whatsapp_number na tabela profiles
ALTER TABLE public.profiles 
ADD COLUMN whatsapp_number text;

-- Também vamos adicionar essa coluna na função get_public_store_info para que seja retornada no catálogo
