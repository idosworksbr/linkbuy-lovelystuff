-- Add product grid layout to profiles table
ALTER TABLE public.profiles 
ADD COLUMN product_grid_layout text DEFAULT 'default' CHECK (product_grid_layout IN ('default', 'round', 'instagram'));

-- Drop and recreate get_public_store_info function with product_grid_layout
DROP FUNCTION IF EXISTS get_public_store_info(text);
