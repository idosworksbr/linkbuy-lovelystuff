-- Fix remaining security definer function issue
-- Drop and recreate the function without SECURITY DEFINER property

DROP FUNCTION IF EXISTS public.get_public_store_info(text);

-- Recreate function without SECURITY DEFINER - regular function is sufficient and safer
